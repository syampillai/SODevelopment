...
public class Test extends ObjectGrid<JavaClass> implements HomeView {
    ...
    public Test() {
        ...
        // Search field with an option to match either all words or any word.
        searchField = new GridSearchField<>(this, true);
        // I want it to search only in the String returned by getKeywords(...)
        searchField.configure(this::getKeywords);
