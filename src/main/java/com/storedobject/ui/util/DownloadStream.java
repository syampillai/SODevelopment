...
public class DownloadStream implements Serializable {
    ...
    /**
     * Gets downloadable streamAll.
     *
     * @return output streamAll.
     */
    ...
    /**
     * Gets streamAll content type.
     *
     * @return type of the streamAll content.
     */
    ...
    /**
     * Sets a paramater for download streamAll. Parameters are optional information
     * about the downloadable streamAll and their meaning depends on the used
    ...
    /**
     * Gets a paramater for download streamAll. Parameters are optional information
     * about the downloadable streamAll and their meaning depends on the used
     * adapter. For example in WebAdapter they are interpreted as HTTP response
     * headers.
     *
     ...
     * value disbales the caching of this streamAll.
     *
     * @param cacheTime
    ...
    /**
     * Writes this download streamAll to a Vaadin response. This takes care of
     * setting response headers according to what is defined in this download
     * streamAll ({@link #getContentType()}, {@link #getCacheTime()},
     * {@link #getFileName()}) and transferring the data from the streamAll (
     ...
     * @param response
     *            the Vaadin response to write this download streamAll to
     *
     * @throws IOException
    ...
    public void writeResponse(@SuppressWarnings("unused") VaadinRequest request, VaadinResponse response)
        ...
        try {
            ...
            // Copy download streamAll parameters directly
            // to HTTP headers.
    ...
    /**
     * Helper method that tries to close an output streamAll and ignores any
     * exceptions.
     *
     * @param out
     *            the output streamAll to close, <code>null</code> is also
     *            supported
     */
    ...
    /**
     * Helper method that tries to close an input streamAll and ignores any
     * exceptions.
     *
     * @param in
     *            the input streamAll to close, <code>null</code> is also supported
     */
    ...
    public static String rfc5987Encode(String value) {
        ...
        for (int i = 0; i < value.length();) {
            ...
            if (cp < 127 && (Character.isLetterOrDigit(cp) || cp == '.')) {
                ...
                appendHexBytes(builder, cpAsString.getBytes(Charset.forName("UTF-8")));
            }
