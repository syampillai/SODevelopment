 ...
 * the style tag should be used, and if used, it should be used only once in the content. If style tags are specified
 * more than once, only the first one is considered and the rest are ignored.
