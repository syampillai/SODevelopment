...
public class AddressField extends CustomField<String> implements ValueRequired {
    ...
    public void setCountry(Country country) {
        if(country == null) {
            country = Country.get(SystemEntity.systemCountry);
        }
        if(country == null) {
            return;
        }
    ...
    public Country getCountry() {
        ...
        if(c == null) {
            c = Country.get(SystemEntity.systemCountry);
            if(c == null) {
                c = Country.get("IN");
            }
        }
    ...
    private void popup() {
        ...
        if(form == null || form.getCountry() != country) {
            ...
            form.setAddressField(this);
        } else {
            form.setAddress(address);
        }
        form.execute(Application.get().getActiveView());
    }
