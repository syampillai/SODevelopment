...
public class CountryField extends TranslatedField<String, Country> {
    ...
    public CountryField(String label) {
        super(new CField(), (f, c) -> c.getShortName(), (f, s) -> Country.get(s), "");
        setLabel(label);
        setValue(SystemEntity.systemCountry);
    }
    ...
    public void setCountry(Country country) {
        setValue(country == null ? SystemEntity.systemCountry : country.getShortName());
    }
