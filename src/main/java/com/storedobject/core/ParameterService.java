...
public interface ParameterService {
	...
	/**
	 * This checks whether this service requires POST method or not (means no GET method is allowed). Default is "true"
	...
	/**
	 * Mime type of the content. If this method returns non-null value, writeResponse method should be implemented
