...
public class FileData extends StoredObject implements Detail, HasParents {
    ...
    public void circulate(Transaction transaction, Person person) throws Exception {
    }

    public void circulate(Transaction transaction, PersonRole personRole) throws Exception {
    }
