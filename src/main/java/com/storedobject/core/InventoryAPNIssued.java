...
public class InventoryAPNIssued extends com.storedobject.core.StoredObject {

    public InventoryAPNIssued() {
    }
    ...
    @com.storedobject.core.annotation.Column(order = 0, style = "(any)", required = true, caption = "")
